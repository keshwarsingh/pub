...
#
# Run:
# fetch -qo - https://raw.githubusercontent.com/keshwarsingh/pub/main/freebsd15-bootstrap.sh | sh
#
...
FREEBSD_MAJOR="$(freebsd-version | sed 's/^\([0-9][0-9]*\).*/\1/')"

if [ "$FREEBSD_MAJOR" != "15" ]; then
  echo "This script is intended for FreeBSD 15.x only."
